...
namespace NiouBusWP8
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            GlobalSettings.Instance.InitializeTheme();
            GlobalSettings.Instance.InitializeAccentColor();
